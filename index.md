# polygonPlot Resources

Welcome! Here you can explore the **polygonPlot** project resources:

- [**Interactive vignette**](polygonPlot.html) – Explore the code examples and functionalities directly from the rendered vignette.
- [**Package repository**](https://github.com/giovannellilab/polygonPlot) – Access the source code, issues, and documentation.
